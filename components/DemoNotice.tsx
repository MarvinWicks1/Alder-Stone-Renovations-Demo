  ...
  return (
    ...
    >
      <div className="container-shell">
        <div className="border border-olive/25 bg-white/75 px-5 py-4 text-sm leading-6 text-charcoal shadow-sm md:flex md:items-center md:justify-between md:gap-6">
          <p>
          ...
          <span className="mt-3 inline-flex bg-limestone px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-olive md:mt-0">
            Example concept
          </span>
        </div>
      </div>
